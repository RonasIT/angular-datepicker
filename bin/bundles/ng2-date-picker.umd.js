    ...
    ***************************************************************************** */
    ...
    var DayCalendarService = /** @class */ (function () {
        ...
        DayCalendarService.prototype.getDisplayMode = function (calendarModeDisplayFirst, currentMode, monthIsSelect) {
            if ((currentMode === exports.ECalendarMode.Day) && (monthIsSelect || calendarModeDisplayFirst === 'day')) {
                return exports.ECalendarMode.Day;
            }
            else if ((currentMode === exports.ECalendarMode.Month) || (!monthIsSelect && calendarModeDisplayFirst === 'month')) {
                return exports.ECalendarMode.Month;
            }
            else {
                return currentMode;
            }
